...
- See [Playlist Access](Playlist%20Access.md#playlist-access--spotifys-2024-api-restrictions) for the 2024 API restrictions that motivated using Exportify as the primary entry point.
...
Exportify is a third-party web app that exports Spotify playlists as CSV files. It pre-dates Spotify's 2024 API tightening and retains grandfathered permissions that let it read any playlist your Spotify account can see — including third-party-owned playlists like Music League's.
