...
> Created interactively with Claude Code, serves as a demonstration of my usage. Some code was manually reviewed, but only sparingly. Makes use of [superpowers](https://github.com/obra/superpowers) plugin.
...
See [docs](docs/Services%20Used.md) for details about required API registrations and authentication details.
